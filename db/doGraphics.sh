...
#1 Tag Auswertung
rrdtool graph $dbpath/jrWetter_1d.png --left-axis-format "%4.1lf" -w 900 -h 500 -E -A \
--right-axis 1:1000 --right-axis-format "%4.1lf" \
...
DEF:press=$dbpath/jrWetter.rrd:press0:AVERAGE CDEF:druck=press,1000,- \
"LINE2:druck#ff0000:Luftdruck\:" "GPRINT:press:LAST:%2.1lf\n"

#7 Tage Auswertung
rrdtool graph $dbpath/jrWetter_7d.png --left-axis-format "%4.1lf" -w 900 -h 500 -E -A \
--right-axis 1:1000 --right-axis-format "%4.1lf" \
...
#30 Tage Auswertung
rrdtool graph $dbpath/jrWetter_30d.png --left-axis-format "%4.1lf" -w 900 -h 500 -E -A \
--right-axis 1:1000 --right-axis-format "%4.1lf" \
